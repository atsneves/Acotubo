...
(function($) {
	$.fn.popover = function(options) {
		...
		var settings = $.extend({
			...
			zindex: 1,		// default z-index value
		...
		$("div").bind("click.popover", function(event) {
		...
		$("div").bind("hideOpenPopover.popover", hideOpenPopover);
